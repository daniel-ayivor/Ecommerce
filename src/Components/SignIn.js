...
function SignIn() {
  return (
    ...
    <h1 className='text-3xl font-bold text-violet-700 mx-4 mb-4'>Sign In</h1>
              ...
              <input  className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm'
               placeholder='password' type='text' /> 
                ...
                <div className='flex gap-x-2'>
                  <button className='bg-violet-700 hover:bg-violet-800 text-white rounded p-4 w-full'>Sign In</button>
   <Link to='/signout' className='border-violet-700 border text-violet-700
    hover:border-violet-500 rounded p-4 text-sm w-full transition'>sign out</Link>
                </div>
        </form>
