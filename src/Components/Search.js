...
import CountryDropdown from '../Drops/CountryDropdown';
import PropertyDropdown from '../Drops/PropertyDropdown';
import PriceRangeDropdown from '../Drops/PriceRangeDropdown'
  ...
  return (
    <div className='px-[30px] py-6 max-w-[1170px] mx-auto flex flex-col lg:flex-row
     ...
     lg:bg-transparent lg:backdrop-blur rounded-lg'>
        ...
        lg:max-w-[164px] h-16 rounded-lg flex justify-center items-center text-white text-lg'>
            <RiSearch2Line />
        </button>
    </div>
  )
